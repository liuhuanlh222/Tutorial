...
//        ProcessBuilder builder = new ProcessBuilder();
//        builder.command("");//程序位置
//        //将标准输入流和错误输入流合并，通过标准输入流程序读取信息
//        builder.redirectErrorStream(true);
//        Process p = builder.start();
        ...
        //源avi视频的路径
        String video_path = "D:\\learning\\xuecheng\\project\\video\\danbai.avi";
        //转换后mp4文件的名称
        String mp4_name = "danbai.mp4";
        //转换后mp4文件的路径
        String mp4_path = "D:\\learning\\xuecheng\\project\\video\\danbai.mp4";
        //创建工具类对象
